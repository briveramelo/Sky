...
public struct DamageKill {
    public int damage; public int Damage { get { return damage; } }
    public int kill;   public int Kill { get { return kill; } }
...
public class BirdStats {
	...
	BirdType myBirdType;		        public BirdType MyBirdType{get{return myBirdType;}}
	Vector2 birdPosition;   	        public Vector2 BirdPosition{get{return birdPosition;} set { birdPosition = value; } }
	int health;					        public int Health{get{return health;} set{health = value;}}
    ...
    public int TotalThreatValue{get{return threat.Total(health);} }
    public int TotalPointValue{	get{return pointBase.Total(health) * basePointMultiplier;} }

	public int GutsToSpill{     get{return guts.GetDeathOrDamage(health<=0, DamageTaken+1);} }
	public int PointsToAdd{     get{return pointsToGive.GetDeathOrDamage(health<=0, DamageTaken) * basePointMultiplier; } }
    public int ThreatRemoved{   get{return threat.GetDeathOrDamage(health<=0, DamageTaken); } }
