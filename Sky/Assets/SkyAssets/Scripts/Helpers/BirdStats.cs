...
public class BirdStats {
	...
	private int _streakPoints;                   public int StreakPoints => _streakPoints * _basePointMultiplier;
	private int _comboPoints;                    public int ComboPoints => _comboPoints * _basePointMultiplier;
